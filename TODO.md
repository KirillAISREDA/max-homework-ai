...
- [ ] Первые 5–10 фото домашних работ → `uv run python -m hwcheck eval <папка>` (замер латентности vision — главный риск); полный датасет 30–50 работ собираем «живьём»
- [ ] Помнить: PERS-фримиум лимитирован по Pro/Max — для полного датасета, вероятно, нужен B2B-пакет токенов
